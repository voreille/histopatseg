...
from histopatseg.models.mil import AttentionAggregator, AttentionAggregatorLoRa
...
def main(
    ...
    train_loader, val_loader, test_loader = get_dataloader(
        ...
        transform=transforms.Compose(get_tile_transform()),
        class_mapping=class_mapping,
        cache_data=True,
    )
    ...
    mil_model = AttentionAggregatorLoRa(
        embedding_dim,
    ...
    trainer = pl.Trainer(
        ...
        logger=TensorBoardLogger("tb_logs", name="mil_from_tiles_lora"),
    )
